...
MOTIVATIONAL_QUOTES = [
    ...
    {"quote": "The art of living easily as to money is to pitch your scale of living one degree below your means.", "author": "Sir Henry Taylor"},
    {"quote": "It is not the man who has too little, but the man who craves more, that is poor.", "author": "Seneca"},
    {"quote": "Every time you borrow money, you are robbing your future self.", "author": "Nathan W. Morris"},
    {"quote": "You must gain control over your money or the lack of it will forever control you.", "author": "Dave Ramsey"},
    {"quote": "Money is a good servant but a bad master.", "author": "Francis Bacon"},
    ...
    {"quote": "A wise person should have money in their head, but not in their heart.", "author": "Jonathan Swift"},
]
